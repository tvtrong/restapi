...
api_v1_urlpatterns = [
    path(
        ...
        include(("awesome.apps.accounts.api.v1.urls", "accounts"), namespace="api-v1-accounts"),
    )
]
...
# enable Swagger
if "SWAGGER" in settings.AWESOME_FEATURES:
    ...
    api_v1_schema_view = get_schema_view(
        openapi.Info(
            title="awesome",
            default_version="v1",
            description="awesome API v1 description",
        ),
        public=True,
