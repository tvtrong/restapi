...
from awesome.apps.accounts.api.v1.serializers.registration import RegistrationSerializer
from awesome.apps.accounts.exceptions import InvalidPasswordError
